...
%--------------------------------------------------------------------------
% Description:  isoDalton_get_isotope_info.m 
%               Returns isotope information for elements up to and 
%               including atomic number 112.
%--------------------------------------------------------------------------
% Input:  None (reads files that should be present)
%         Note: Warning: Contains a hard coded path that needs to be set to
%         where isoDalton_element_info.mat is located.
%--------------------------------------------------------------------------
