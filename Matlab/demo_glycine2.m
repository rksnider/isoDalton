...
%--------------------------------------------------------------------------
% Description:  demo_glycine2.m 
%               This demo plots the exact probability profile (within 
%               double precision) of the 13 masses that are separated by 
%               near integer spacing of glycine.
%--------------------------------------------------------------------------
...
maxstates = 13;       % for ~integer separated ave values
massdiff_threshold = 0.2;
minprob_threshold = 10^(-6);
states = isoDalton_exact_probability(molecule,maxstates,massdiff_threshold,minprob_threshold);
...
ylabel('Probability');
title(['Distribution of Glycine C_{2}H_{5}N_{1}O_{2}   Exact Probability'])
